...
namespace Ag {
	...
	public class Account : GLib.Object {
		...
		public Ag.SettingSource get_value (string key, GLib.Value value);
	...
	public class Manager : GLib.Object {
		...
		public string service_type { construct; }
	...
	[CCode (cheader_filename = "libaccounts-glib/accounts-glib.h")]
	public enum Error {
		[CCode (cname = "AG_ERROR_DB")]
		DB,
		[CCode (cname = "AG_ERROR_DISPOSED")]
		DISPOSED,
		[CCode (cname = "AG_ERROR_DELETED")]
		DELETED,
		[CCode (cname = "AG_ERROR_DB_LOCKED")]
		DB_LOCKED,
		[CCode (cname = "AG_ERROR_ACCOUNT_NOT_FOUND")]
		ACCOUNT_NOT_FOUND
	}
	[CCode (cheader_filename = "libaccounts-glib/accounts-glib.h")]
	public enum SettingSource {
		[CCode (cname = "AG_SETTING_SOURCE_NONE")]
		NONE,
		[CCode (cname = "AG_SETTING_SOURCE_ACCOUNT")]
		ACCOUNT,
		[CCode (cname = "AG_SETTING_SOURCE_PROFILE")]
		PROFILE
	}
